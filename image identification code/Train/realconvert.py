...
keras_model = load_model(r"C:/Users/江淼/Desktop/2019train/model/zhongkong_ft_2.h5")

output_dir = os.path.join(os.getcwd(),"checkpoint")

keras_to_tensorflow(keras_model,output_dir="C:/Users/江淼/Desktop/2019train/converted_tf_model",model_name="squeezenet_test.pb")
